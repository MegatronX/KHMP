...
namespace Cache
{
	...
	TextureCache::res_ptr TextureCache::RequestResource(const std::string &indexer, sf::Uint32 time, const std::string extension)
	{
		return DefaultResource;
	}
	TextureCache::res_ptr TextureCache::RequestResource(const std::string &indexer, sf::Uint32 time, Cache::ResourceClass resClass, const std::string extension)
	{
		return RequestResource(indexer, Cache::GameStyle::Main, Cache::World::Any, resClass, time, 0, false, extension);
	}
	TextureCache::res_ptr TextureCache::RequestResource(const std::string &indexer, Cache::GameStyle style, Cache::World world, Cache::ResourceClass resClass, sf::Uint32 time, sf::Uint32 lifeTime, bool AsCopy, const std::string extension)
	{
	...
	void TextureCache::InitializePaths(Configuration::AppConfiguration &configuration)
	{
		...
		std::string MainSpriteDirectory = SpriteDirectory;//(SpriteDirectory + configuration.GetApplicationSetting("MainGameSpriteDir"));
		MainPaths.SpriteDirectory = MainSpriteDirectory;
		MainPaths.BossSubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("BossSubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.ChasersSubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("ChasersSubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.EnemySubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("EnemySubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.GuardianSubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("GuardianSubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.NPCSubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("NPCSubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.WeaponsSubDirectory = MainSpriteDirectory + configuration.GetApplicationSetting("GuardianSubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.TitleScreenSubDirectory = configuration.GetApplicationSetting("ResourcesBaseDirectory") + configuration.GetApplicationSetting("GraphicsSubDir") + configuration.GetApplicationSetting("TitleScreenSubDir");// + Appconfiguration.GetApplicationSetting()]
		MainPaths.GUISubDirectory = configuration.GetApplicationSetting("ResourcesBaseDirectory") + configuration.GetApplicationSetting("GraphicsSubDir") + configuration.GetApplicationSetting("SpriteSubDir") + configuration.GetApplicationSetting("GUISubDir") + configuration.GetApplicationSetting("MainGameSpriteDir");
		MainPaths.GUIBattleSubDirectory = MainPaths.GUISubDirectory + configuration.GetApplicationSetting("GUIBattleSubDir");
		MainPaths.GUIMenuSubDirectory = MainPaths.GUISubDirectory + configuration.GetApplicationSetting("GUIMenuSubDir");
