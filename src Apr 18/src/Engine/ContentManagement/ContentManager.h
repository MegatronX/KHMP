...
namespace Content
{
	...
	public:
		...
		boost::shared_ptr<sf::Texture> RequestTexture(const std::string &name, Cache::GameStyle style, Cache::World world, Cache::ResourceClass rClass, sf::Uint32 time, std::string extension = ".png");
		...
		Graphics::animspr_ptr RequestAnimatedSprite(const std::string& name, const Cache::GameStyle, const Cache::World, const Cache::ResourceClass, const sf::Uint32 time, const bool Start = false, const std::string extension = ".png");
	...
	protected:
		...
		boost::unordered_map<std::string, boost::shared_ptr<::Graphics::Animator> > StoredAnimators;
