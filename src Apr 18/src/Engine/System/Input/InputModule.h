...
namespace Input
{
	...
	public:
		...
		bool IsActionPushed(PlayerInput input, const InputAction action) const;

		boost::signals::connection AddKeyPressedEvent(const KeyChangeEvent::slot_type& handler);
		void DispatchKeyPressedEvents(const sf::Uint32 time, sf::Event::KeyEvent& keyEvent, bool DispatchInvalidActions = true);
		void DispatchJoystickKeyPressedEvents(const sf::Uint32 time, sf::Event::JoystickButtonEvent& joyEvent, bool DispatchInvalidActions = true);

		boost::signals::connection AddKeyReleasedEvent(const KeyChangeEvent::slot_type& handler);
		void DispatchKeyReleasedEvents(const sf::Uint32 time, sf::Event::KeyEvent& keyEvent, bool DispatchInvalidActions = true);
		void DispatchJoystickKeyReleasedEvents(const sf::Uint32 time, sf::Event::JoystickButtonEvent& joyEvent, bool DispatchInvalidActions = true);
