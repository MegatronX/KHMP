...
namespace Game
{
	namespace Components
	{
		...
		StatusEffectivenessComponent::StatusEffectivenessComponent(const boost::unordered_map<std::string, float>& effTable) : EffectivenessTable(effTable), DefaultEffectivenessTable(effTable)
		{
