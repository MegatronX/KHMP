...
namespace Cache
{
	...
	public:
		...
		res_ptr RequestResource(const std::string &indexer, sf::Uint32 time, const std::string extension = ".png") override;
		res_ptr RequestResource(const std::string &indexer, sf::Uint32 time, Cache::ResourceClass resClass, const std::string extension = ".png");
		res_ptr RequestResource(const std::string &indexer, Cache::GameStyle style, Cache::World world, Cache::ResourceClass resClass, sf::Uint32 time, sf::Uint32 lifeTime = 0, bool AsCopy = false, const std::string = ".png") override;
