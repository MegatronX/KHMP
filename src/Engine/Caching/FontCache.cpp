...
namespace Cache
{
	...
	FontCache::res_ptr FontCache::RequestResource(const std::string &indexer, sf::Uint32 time, const std::string extension)
	{
	...
	FontCache::res_ptr FontCache::RequestResource(const std::string &indexer, GameStyle style, World world, ResourceClass resClass, sf::Uint32 time, sf::Uint32 lifeTime, bool AsCopy, const std::string extension)
	{
