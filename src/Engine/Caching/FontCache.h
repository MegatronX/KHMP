...
namespace Cache
{
	...
	public:
		...
		virtual res_ptr RequestResource(const std::string &indexer, sf::Uint32 time, const std::string extention = ".png") override;
	...
	protected:
		...
		virtual res_ptr RequestResource(const std::string &indexer, GameStyle style, World world, ResourceClass resClass, sf::Uint32 time, sf::Uint32 lifeTime = 0, bool AsCopy = false, const std::string extension = ".png") override;
	private:
	};
}
