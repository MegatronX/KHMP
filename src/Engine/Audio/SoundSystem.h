...
namespace Audio
{
	...
	public:
		...
		void PlaySound(const std::string &soundName, int channel = 0, bool loop = true, float Volume = 1.0);
		void PlaySoundSection(const std::string &soundName, int channel = 0, bool loop = true, int StartMilliseconds = -1, int EndMilliseconds = -1, float Volume = 1.0);
